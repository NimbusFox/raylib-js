...
module Raylib {
    /** 
     * Only to be used when you want to talk to raylib directly. Keep in mind you will be playing with pointers and not structs from here on out
     */
    ...
    export function GetClipboardText(): string {
        return raylibC.GetClipboardText();
    }
    ...
    export function IsCursorOnScreen(): boolean {
        return raylibC.IsCursorOnScreen();
    }
    ...
    export function BeginMode3D(): void {
        raylibC.BeginMode3D();
    }
    ...
    export function SetCameraMode(camera: Camera3D, mode: Enums.CameraMode): void {
        throw new Error("Method not implemented.");
    }
    
    export function UpdateCamera(camera: Camera3D): Camera3D {
        throw new Error("Method not implemented.");
    }
    ...
    export function DrawBillboard(camera: Camera3D, texture: Texture, center: Vector3, size: number, tint: Color): void {
        throw new Error("Method not implemented.");
    }
    
    export function DrawBullboardRec(camera: Camera3D, texture: Texture, source: Rectangle, center: Vector3, size: number, tint: Color): void {
        throw new Error("Method not implemented.");
    }
    ...
    export function UpdateVrTracking(camera: Camera3D): void {
        throw new Error("Method not implemented.");
    }
